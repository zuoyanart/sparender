...
const configPro = require('../config/config.pro');
...
module.exports = class {
  ...
  config(key) {
    ...
    if (this.env === 'production') {
      c = Object.assign(configN, configPro);
    } else if (this.env === 'test') {
      c = Object.assign(configN, configTest);
    }
    if (this.isEmpty(key)) {
      return c;
    }
